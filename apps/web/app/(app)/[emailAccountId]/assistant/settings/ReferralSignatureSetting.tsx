...
export function ReferralSignatureSetting() {
  ...
  return (
    <SettingCard
      ...
      description="Add 'Drafted by Clarent Email Management' with your referral link to emails we draft for you. Earn a month of credit for each person who signs up with your link."
      right={
        <LoadingContent
          loading={isLoading}
          error={error}
