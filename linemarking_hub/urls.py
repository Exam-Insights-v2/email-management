...
from linemarking_hub.views import (
    ...
    draft_attachment_download,
    draft_attachment_remove,
    draft_create,
    draft_delete,
    draft_detail,
    draft_rewrite,
...
urlpatterns = [
    ...
    path("drafts/<int:pk>/attachments/", draft_attachment_add, name="draft_attachment_add"),
    path("drafts/<int:pk>/attachments/<int:attachment_id>/download/", draft_attachment_download, name="draft_attachment_download"),
    path("drafts/<int:pk>/attachments/<int:attachment_id>/remove/", draft_attachment_remove, name="draft_attachment_remove"),
